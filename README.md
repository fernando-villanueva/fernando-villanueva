<h1 align="center">👉 👋 Welcome to my GitHub — I’m Fernando Villanueva  👋 👈</h1>
...
<div align="center">
  <img src="https://count.getloli.com/@:fernando-villanueva?theme=3d-num&padding=7&scale=1&align=top&pixelated=1&darkmode=1"  />
</div>
...
<p align="center">👋 Hi, I’m Fernando Villanueva<br>Fullstack Developer | Software Architect | Security-Oriented Developer | DevOps<br><br>🚀 I build robust, scalable, and secure solutions<br>🔐 Strong focus on best practices, clean architecture, and security<br>🧠 Logical, structured, and business-oriented mindset<br><br>👨‍💻 About Me<br><br>I am a Fullstack Developer with experience in web applications, backend systems, APIs, and scalable platforms, focused on:<br><br>• Clean and modular architecture (OOP)<br>• Maintainable, well-documented, and reusable code<br>• Security, access control, and data protection<br>• Optimization for development, testing, and production environments<br><br>I enjoy building well-thought-out projects from the ground up, avoiding improvised solutions and prioritizing long-term quality.<br><br>🛠️ Technologies & Stack<br><br>💻 Backend<br>PHP (LAMP)<br>Node.js / Express<br>REST APIs<br>Authentication, JWT, Webhooks<br>Security (OWASP, validations, hardening)<br><br>🌐 Frontend<br>JavaScript<br>HTML5 / CSS3<br>React / MERN<br>Clean and functional interfaces<br><br>🗄️ Databases<br>MySQL<br>MongoDB<br>Schema design and query optimization<br><br>⚙️ DevOps & Infrastructure<br>Docker (containers and deployment)<br>Environment variables<br>Environment separation<br>Prepared for AWS / Google Cloud<br><br>🔐 Security & Best Practices<br><br>✔ Object-Oriented Programming (OOP)<br>✔ SOLID principles<br>✔ Defensive and fault-tolerant code<br>✔ Secure credential handling<br>✔ ISO/IEC 27001–aligned approach<br>✔ Common vulnerability prevention<br><br>📂 About My Repositories<br><br>📁 Clear and well-organized structures<br>📄 Commented and documented code<br>🧪 Designed for local testing and production<br>🔄 Scalable and easy to maintain<br>🛡️ Strong focus on security and stability<br><br>📫 Contact<br><br>If you’re interested in collaborating, learning together, or reviewing a project, communication is always professional and direct through this profile.<br><br>“Good software doesn’t just work — it is understood and protected.”</p>

###

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/fernando-villanueva/fernando-villanueva/output/pacman-contribution-graph-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/fernando-villanueva/fernando-villanueva/output/pacman-contribution-graph.svg">
  <img alt="pacman contribution graph" src="https://raw.githubusercontent.com/fernando-villanueva/fernando-villanueva/output/pacman-contribution-graph.svg">
</picture>
